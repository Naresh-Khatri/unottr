...
import {
  disable as autostartDisable, enable as autostartEnable, isEnabled as autostartIsEnabled,
} from "@tauri-apps/plugin-autostart";
import { api, onModelDownloadProgress } from "@/ipc/client";
import type {
      ...
      <div className="mx-auto flex max-w-2xl flex-col gap-6 pb-8">
        ...
        <GeneralCard
          ...
          onAutostartChange={async (on) => {
            if (on) await autostartEnable(); else await autostartDisable();
            setAutostartOn(on);
