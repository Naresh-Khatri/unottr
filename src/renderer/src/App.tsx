...
import { QueueShelf } from "@/ui/QueueShelf";
...
export default function App() {
  ...
  if (firstRunDone === null) {
    return <LoadingState label="Opening unottr" className="h-full bg-background" />;
  }
  ...
  return (
    <div className="flex h-full flex-col bg-background">
      ...
      <QueueShelf onOpen={(id) => setView({ screen: "transcript", id, ms: 0 })} />
    </div>
  );
}
